    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product">
                    <div class="product-top">
                        <a href="/product/single/fit-flare-dress-2"><img class="product-thumbnal" src="{{ asset('front/assets/images/products/tshirt.png') }}" alt="product" />
                        </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product">
                    <div class="product-top">
                        <a href="product-details.html"><img class="product-thumbnal" src="{{ asset('front/assets/images/products/tshirt.png') }}" alt="product" />
                        </a>
                        <div class="product-flags">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product">
                    <div class="product-top">
                        <a href="/product/single/rosmo-namino-2"><img class="product-thumbnal" src="{{ asset('front/assets/images/products/tshirt.png') }}" alt="product" />
                        </a>
                        <div class="product-flags">
                            <span class="product-flag sale">HOT</span>
                            <span class="product-flag discount">-10.00</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product">
                    <div class="product-top">
                        <a href="/product/single/Best-t-Shirt-for-male"><img class="product-thumbnal" src="{{ asset('front/assets/images/products/tshirt.png') }}" alt="product" />
                        </a>
                        <div class="product-flags">
                            <span class="product-flag sale">NEW</span>
                            <span class="product-flag discount">-10.00</span>
