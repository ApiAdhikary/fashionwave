                ...
                <div class="container">
                    <div class="header-middle-wrap">
                        <div class="brand-area">
                            <a class="brand-logo" href="{{ url('' )}}"><img class="brand-image" src="{{ asset('front/assets/images/logo.png') }}" alt="Fashionwave" />
                            </a>
                        </div>
            ...
            <div class="container">
                <div class="menu-wrap">
                    <div class="header-left">
                        <a class="brand-logo" href="http://127.0.0.1:8000"><img class="brand-image" src="{{ asset('front/assets/images/logo.png') }}" alt="Fashionwave" />
                        </a>
                    </div>
                    <div class="header-right">
                        <a href="{{ route( 'wishlist.index') }}" class="wishlist-btn header-btn">
                ...
                <div class="product-item cart-product-item">
                    <div class="single-grid-product">
                        <div class="product-top">
                            <a href="javascript:void(0)"><img class="product-thumbnal" src="{{ asset('front/assets/images/products/tshirt.png') }}" alt="cart">
                            </a>
                        </div>
