                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-contact-info border-0 text-center">
                                ...
                                src=" <?php echo e(asset('front/assets/images/contact-info-1.png')); ?>"
                                    alt="contact-info" />
                                <h3 class="contact-info-title">Email</h3>
                                <p class="contact-info-content">
                                  <?php echo e(get_settings()->email ?? ""); ?> 
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-contact-info text-center">
                                <img class="contact-info-icon" 
                                  src=" <?php echo e(asset('front/assets/images/contact-info-2.png')); ?>"
                            
                                    alt="contact-info" />
                                <h3 class="contact-info-title">Address</h3>
                                <p class="contact-info-content">
                                    <?php echo e(get_settings()->address ?? ""); ?>  <br />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-contact-info text-center">
                                <img class="contact-info-icon"
                                  src=" <?php echo e(asset('front/assets/images/contact-info-3.png')); ?>"
...
<?php echo $__env->make('front.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fashionwave\resources\views/front/pages/contact-us.blade.php ENDPATH**/ ?>