  <!-- footer area start here -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                        <div class="single-widget about-widget">
                            <a href="http://127.0.0.1:8000" class="footer-brand-logo mb-25"><img
                                 src="<?php echo e(asset('front/assets/images/logo.png')); ?>" alt="footer-logo" />
                            </a>
                            <p class="address-text">
                                <?php echo e(get_settings()->address ?? ""); ?> 
                            </p>
                            <div class="block-content mb-30">
                                <p class="contact">Call us:    <?php echo e(get_settings()->phone ?? ""); ?> </p>
                                <p class="contact">Email:    <?php echo e(get_settings()->email ?? ""); ?> </p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="single-widget">
                                    ...
                                    <ul class="widget-menu">
                                        <li class="menu-item"><a class="menu-link" href="<?php echo e(route('faq' )); ?>">Help
                                                &amp; FAQ</a></li>
                                        <li class="menu-item"><a class="menu-link" href="<?php echo e(route('terms.conditions' )); ?>">Terms of
                                                Conditions</a>
                                        </li>
                                        <li class="menu-item"><a class="menu-link" href="<?php echo e(route('privacy.policy' )); ?>">Privacy
                                                Policy</a>
                                        </li>
                                        <li class="menu-item"><a class="menu-link" href="<?php echo e(route('contact.us' )); ?>">Contact Us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="footer-bottom">
            <div class="container-fluid">
                <div class="footer-bottom-wrap">
                    Designed &amp; Developed By Api Adhikary
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="<?php echo e(asset('front/assets/js/front/custom.js')); ?>"></script>
    <script src="<?php echo e(asset('front/assets/js/front/extra.js')); ?>"></script>
    <script src="<?php echo e(asset('front/assets/js/front/sweat_aleart.js')); ?>"></script>
    <script src="<?php echo e(asset('front/assets/js/common.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('front/assets/js/pages/home.js')); ?>"></script>
  <script src="<?php echo e(asset('front/assets/js/pages/cart.js')); ?>"></script>
  <?php /**PATH C:\xampp\htdocs\fashionwave\resources\views/front/layouts/partials/footer.blade.php ENDPATH**/ ?>