    ...
    <div id="preloader">
        <div id="status">
            <img src="<?php echo e(asset('front/assets/images/preloader.svg')); ?>" alt="img" />
                            ...
                            <div class="header-top-right">
                                ...
                                <div class="switcher-lang-currency">
                                    <div class="lang-switcher">
                                        <span class="flag"><img src="<?php echo e(asset('front/assets/images/language/en.png')); ?>" 
                                        ...
                                        <ul class="lang-list">
                                            <li class="single-lang"><span class="flag"><img
                                                        src="<?php echo e(asset('front/assets/images/language/fr.png')); ?>"  alt="india"></span><a
                                ...
                                <div class="account-switcher">
                                    <span class="flag"><img src="<?php echo e(asset('front/assets/images/user-avatar11.png')); ?>"
                ...
                <div class="container">
                    <div class="header-middle-wrap">
                        <div class="brand-area">
                            <a class="brand-logo" href="<?php echo e(url('' )); ?>"><img class="brand-image" src="<?php echo e(asset('front/assets/images/logo.png')); ?>" alt="Fashionwave" />
                            </a>
                        </div>
                        ...
                        <div class="header-right">
                            ...
                            <div class="wishlist single-btn">
                                <a href="<?php echo e(route( 'wishlist.index')); ?>" class="wishlist-btn header-btn">
                                    <div class="btn-left">
                            ...
                            <div class="compare single-btn">
                                <a href="<?php echo e(route ('compare.index')); ?>" class="compare-btn header-btn">
                                    <div class="btn-left">
                ...
                <nav class="menu-area">
                    <ul class="main-menu">
                        <li class="menu-item menu-item-has-children active">
                            <a class="menu-link" href="<?php echo e(url('/' )); ?>">Home</a>
                        </li>
                        <li class="menu-item "><a class="menu-link" href="<?php echo e(route('product.index')); ?>">Shop</a>
                        </li>

                        <li class="menu-item "><a class="menu-link" href="<?php echo e(route('about.us' )); ?>">About Us</a>
                        </li>
                        <li class="menu-item ">
                            <a class="menu-link" href="<?php echo e(route('contact.us' )); ?>">Contact</a>
                        </li>
            ...
            <div class="container">
                <div class="menu-wrap">
                    <div class="header-left">
                        <a class="brand-logo" href="http://127.0.0.1:8000"><img class="brand-image" src="<?php echo e(asset('front/assets/images/logo.png')); ?>" alt="Fashionwave" />
                        </a>
                    </div>
                    <div class="header-right">
                        <a href="<?php echo e(route( 'wishlist.index')); ?>" class="wishlist-btn header-btn">
    ...
    <div class="offcanvas offcanvas-start menu-offcanvas" tabindex="-1" id="offcanvasMobileMenu">
        <div class="mobile-menu-area">
            ...
            <nav class="main-menu">
                <ul class="menu-list">
                    <li class="menu-item"><a class="menu-link" href="<?php echo e(url('' )); ?>">Home</a></li>
                    ...
                    <li class="menu-item"><a class="menu-link" href="<?php echo e(route('about.us' )); ?>">About Us</a></li>
                    <li class="menu-item"><a class="menu-link" href="<?php echo e(route('contact.us' )); ?>">Contact</a></li>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="cartOffcanvasSidebar"
        ...
        <div class="offcanvas-body">
                ...
                <div class="product-item cart-product-item">
                    <div class="single-grid-product">
                        <div class="product-top">
                            <a href="javascript:void(0)"><img class="product-thumbnal" src="<?php echo e(asset('front/assets/images/products/tshirt.png')); ?>" alt="cart">
                            </a>
                        </div>
            ...
            <div class="total-bottom-part">
                ...
                <a href="<?php echo e(route( 'checkout.index')); ?>" class="proceed-to-btn d-block text-center">
                    Proceed To Checkout
                </a>
    ...
    <div id="CartDecrementFromSession" data-url="/cart/decrease"></div><?php /**PATH C:\xampp\htdocs\fashionwave\resources\views/front/layouts/partials/header.blade.php ENDPATH**/ ?>