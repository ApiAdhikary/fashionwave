...
<div class="breadcrumb-area">
    <div class="container">
        <div class="breadcrumb-wrap text-center">
            <h2 class="page-title"><?php echo e($data->title ?? ""); ?></h2>
        ...
        <div class="row align-items-lg-center">
            <div class="col-lg-5 offset-lg-1 col-md-6">
                <div class="about-us-image">
                    <img src="<?php echo e(asset('front/assets/images/about_us_page/aboutus-image.jpg')); ?>" alt="about us image" />
                </div>
            </div>
...
<?php echo $__env->make('front.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fashionwave\resources\views/front/pages/about-us.blade.php ENDPATH**/ ?>