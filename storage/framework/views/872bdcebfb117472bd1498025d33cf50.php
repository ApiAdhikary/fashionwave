                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-image">
                                                <a href="/product/single/rosmo-namino-2"><img class="product-thumbnal"
                                                        src="<?php echo e(asset ('front/assets/images/products/tshirt.png')); ?>"
                                        ...
                                        <td>
                                            <button class="delet-btn deleteWishlist" data-id="1" title="Delete Item">
                                                <img src="<?php echo e(asset ('front/assets/images/close.svg')); ?>" alt="close" /></button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
<?php echo $__env->make('front.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fashionwave\resources\views/front/wishlist/index.blade.php ENDPATH**/ ?>